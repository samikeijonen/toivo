...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="entry-inner">
		...
		<footer class="entry-footer">
			<?php toivo_post_terms( array( 'taxonomy' => 'jetpack-portfolio-type', 'text' => __( 'Portfolio in %s', 'toivo' ) ) ); ?>
			<?php toivo_post_terms( array( 'taxonomy' => 'jetpack-portfolio-tag', 'text' => __( 'Tagged %s', 'toivo' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
