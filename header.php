...
<div id="page" class="site">
	...
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'toivo' ); ?></a>
			...
			<div class="wrap-inside">
				...
				<?php
					if ( function_exists( 'breadcrumb_trail' ) && current_theme_supports( 'breadcrumb-trail' ) ) :
						breadcrumb_trail( array( 'container' => 'nav', 'show_on_front' => false, 'show_browse' => false, 'before' => '<h2 class="screen-reader-text">' . esc_attr__( 'Breadcrumbs', 'toivo' ) . '</h2><div class="wrap">', 'after' => '</div>' ) );
					endif;
				?>
