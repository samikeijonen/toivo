		...
		<div class="comment-content" <?php hybrid_attr( 'comment-content' ); ?>>
			...
			<div class="comment-content-wrapper">
				...
				<?php if ( '0' == $comment->comment_approved ) : ?>
					<p>	
						<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'toivo' ); ?></em>
					</p>
				<?php endif; ?>
				...
				<p class="comment-meta">
					...
					<a class="comment-permalink" <?php hybrid_attr( 'comment-permalink' ); ?> href="<?php echo esc_url( get_comment_link( $comment->comment_ID, $args ) ); ?>"><time class="comment-published" datetime="<?php comment_time( 'c' ); ?>" <?php hybrid_attr( 'comment-published' ); ?>><?php printf( _x( '%1$s', '%1%s is for comment date', 'toivo' ), get_comment_date() ); ?></time></a>
