			 ...
			 */
				...
				$toivo_featured_area = esc_attr( get_theme_mod( 'front_page_featured', 'child-pages' ) );
				
				if( 'blog-posts' == $toivo_featured_area ) :
					
					/* Blog Posts Query. */
					$featured_content = new WP_Query( apply_filters( 'toivo_blog_posts_arguments', array(
					'post_type'      => 'post',
					'posts_per_page' => 4,
					'no_found_rows'  => true,
					) ) );
				...
				elseif( 'portfolios' == $toivo_featured_area ) :
					...
					/* Portfolios Query. */
					$featured_content = new WP_Query( apply_filters( 'toivo_portfolio_arguments', array(
					...
					/* Child Pages Query. */
					$featured_content = new WP_Query( apply_filters( 'toivo_child_pages_arguments',array(
						'post_type'      => 'page',
						'orderby'        => 'menu_order',
						'order'          => 'ASC',
						'post_parent'    => $post->ID,
