...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="entry-inner">
		...
		<header class="entry-header">
			...
			if( is_rtl() ) :
				$toivo_left_or_right = _x( '&larr;', 'Arrow for link post format in right to left languages', 'toivo' );
			else :
				$toivo_left_or_right = _x( '&rarr;', 'Arrow for link post format in left to right languages', 'toivo' );
			endif;
			?>
			...
			<<?php echo $heading; ?> class="entry-title" <?php echo hybrid_get_attr( 'entry-title' ); ?>>
				<a href="<?php echo esc_url( toivo_get_link_url() ); ?>"><?php the_title(); ?> <span class="meta-nav"><?php echo esc_attr( $toivo_left_or_right ); ?></span></a>
			</<?php echo $heading; ?>>
